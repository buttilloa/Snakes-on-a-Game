...
namespace Snakes_on_a_Game
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        Color[] WhiteScheme= { Color.White, Color.White, Color.MintCream, Color.MintCream, Color.OldLace, Color.OldLace};
        Color[] AiScheme = { Color.Blue };
        public Game1()
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (Pellet.Center.X > Aisnake.getFront().Center.X && Aisnake.Facing != 2) Aisnake.Facing = 0;
            else if (Pellet.Center.X < Aisnake.getFront().Center.X && Aisnake.Facing != 0) Aisnake.Facing = 2;
            else if (Pellet.Center.Y > Aisnake.getFront().Center.Y && Aisnake.Facing != 3) Aisnake.Facing = 1;
            else if (Pellet.Center.Y < Aisnake.getFront().Center.Y && Aisnake.Facing != 1) Aisnake.Facing = 3;
           /*
